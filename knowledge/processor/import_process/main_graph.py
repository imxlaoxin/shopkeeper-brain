...
from knowledge.processor.import_process.nodes.bge_embedding import BGEEmbedding
...
def create_import_graph() -> CompiledStateGraph:
    ...
    nodes = {
        ...
        "bge_embedding_node": BGEEmbedding(),
...
def run_import_graph(import_file_path: str, file_dir: str) -> dict:
    ...
    for event in kb_import_graph_app.stream(state): # 默认stream_mode为'updates'
...
if __name__ == "__main__":
    ...
    import_file_path = r"G:\project\python\AI-Model\project\shopkeeper-brain\knowledge\processor\import_process\doc\HUAWEI MateStation S 12代酷睿版 用户指南-(PUC,Windows11_02,zh-cn).pdf"
